...
import QuickMoodSelect from "../../components/QuickMoodSelect";
...
const Diag: React.FC = () => {
  ...
  }, [setHighlightedLabels, setHighlightedColor]);
  ...
  const handleQuickLabelSelect = useCallback(
    (labels: string[]) => {
      setHighlightedLabels(labels);
    },
    [setHighlightedLabels]
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 py-10">
        ...
        >
          ...
          <div className="grid gap-4 sm:gap-6">
            {/* 원터치 모드 */}
            <motion.button
              className="relative p-6 sm:p-8 rounded-2xl bg-white dark:bg-gray-800 border-2 border-violet-200 dark:border-violet-800 
                shadow-lg hover:shadow-xl hover:border-violet-400 dark:hover:border-violet-600 transition-all duration-300 text-left group"
            ...
            {/* 상세 모드 */}
            <motion.button
              className="relative p-6 sm:p-8 rounded-2xl bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 
                shadow-lg hover:shadow-xl hover:border-indigo-400 dark:hover:border-indigo-600 transition-all duration-300 text-left group"
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
  ...
  if (mode === "quick") {
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
        ...
        <QuickMoodSelect
          onColorSelect={handleQuickColorSelect}
          onDetailedMode={() => setMode("detailed")}
          onLabelSelect={handleQuickLabelSelect}
        />
      </div>
    );
  }
